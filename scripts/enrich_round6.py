"""2026-04-20 round 6 — finish the large-brand backfill sweep. Targets
brands with >= 10 models and img/m < 16."""
...
TARGETS = [
    ("grand-design", "90 m, 7.2 img/m — biggest remaining upside"),
    ("airstream", "47 m, 14.1 img/m — force_stealth"),
    ("brinkley", "15 m, 14.8 img/m — force_stealth"),
    ("wildwood-rv", "13 m, 12.7 img/m"),
    ("highland-ridge", "12 m, 12 img/m"),
    ("r-pod", "11 m, 7.9 img/m"),
    ("solera", "10 m, 7.6 img/m"),
    ("coach-house", "10 m, 12.9 img/m"),
]
...
async def main():
    ...
    out = Path(__file__).resolve().parent / "logs" / f"enrich_r6_{int(time.time())}.json"
